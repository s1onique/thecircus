...
let private conflictingEvidenceRecords (evId: string) : string * string =
    let rec1 =
        sprintf
            """{"schema_version":"verification-evidence-v1","verification_evidence_id":"%s","episode_id":"ep-001","verification_kind":"build","verification_command":"dotnet build","verification_result":"pass","verification_exit_code":0,"tested_commit_oid":"%s","tested_tree_oid":"%s"}"""
            evId
            validCommitOid
            validTreeOid
    ...
    let rec2 =
        sprintf
            """{"schema_version":"verification-evidence-v1","verification_evidence_id":"%s","episode_id":"ep-002","verification_kind":"build","verification_command":"dotnet build","verification_result":"fail","verification_exit_code":1,"tested_commit_oid":"%s","tested_tree_oid":"%s"}"""
            evId
            validCommitOid
            validTreeOid
        ...
        [
                  ...
                  | [ VerificationIssue.VerificationEvidenceLoadFailed errors ] ->
                      let hasMalformed =
                          ...
                          |> List.exists (function
                              | VerificationEvidenceLoadError.ParseError(VerificationEvidenceParseError.MalformedJson _) ->
                                  true
                              | _ -> false)
              ...
              try
                  ...
                  | [ VerificationIssue.VerificationEvidenceLoadFailed errors ] ->
                      ...
                      | [ VerificationEvidenceLoadError.ConflictingEvidenceRecord _ ] ->
                          ...
                          failwithf
                              "expected DuplicateEvidenceId error for identical records, got ConflictingEvidenceRecord"
          ...
          test "wrong field type (episode_id as number) => WrongFieldType error" {
              ...
              try
                  ...
                  | [ VerificationIssue.VerificationEvidenceLoadFailed errors ] ->
                      ...
                      let hasWrongFieldType =
                          errors
                          |> List.exists (function
                              | VerificationEvidenceLoadError.ParseError(VerificationEvidenceParseError.WrongFieldType _) ->
                                  true
                              | _ -> false)
              ...
              try
                  ...
                  | [ VerificationIssue.VerificationEvidenceLoadFailed errors ] ->
                      let hasInvalidSha =
                          errors
                          |> List.exists (function
                              | VerificationEvidenceLoadError.ParseError(VerificationEvidenceParseError.InvalidSha256 _) ->
                                  true
                              | _ -> false)
          ...
          test "conflicting evidence records produce ConflictingEvidenceRecord" {
              ...
              try
                  ...
                  let rec1 =
                      sprintf
                          """{"schema_version":"verification-evidence-v1","verification_evidence_id":"%s","episode_id":"ep-conflict-1","verification_kind":"build","verification_command":"dotnet build","verification_result":"pass","verification_exit_code":0,"tested_commit_oid":"%s","tested_tree_oid":"%s"}"""
                          validEvidenceId
                          validCommitOid
                          validTreeOid
                  ...
                  let rec2 =
                      sprintf
                          """{"schema_version":"verification-evidence-v1","verification_evidence_id":"%s","episode_id":"ep-conflict-2","verification_kind":"focused_test","verification_command":"dotnet test","verification_result":"fail","verification_exit_code":1,"tested_commit_oid":"%s","tested_tree_oid":"%s"}"""
                          validEvidenceId
                          validCommitOid
                          validTreeOid
          ...
          test "schema_version missing => MissingField error" {
              ...
              try
                  ...
                  match vr.Issues with
                  | [ VerificationIssue.VerificationEvidenceLoadFailed errors ] ->
                      let hasMissingSchema =
                          errors
                          |> List.exists (function
                              | VerificationEvidenceLoadError.ParseError(VerificationEvidenceParseError.MissingField _) ->
                                  true
                              | _ -> false)
              ...
              try
                  ...
                  let bad =
                      ...
                      |> fun s ->
                          s.Replace(
                              ...
                              "\"schema_version\":\"verification-evidence-v99\""
                          )
                  ...
                  | [ VerificationIssue.VerificationEvidenceLoadFailed errors ] ->
                      let hasUnsupported =
                          errors
                          |> List.exists (function
                              | VerificationEvidenceLoadError.ParseError(VerificationEvidenceParseError.UnsupportedSchemaVersion _) ->
                                  true
                              | _ -> false)
              ...
              try
                  ...
                  | [ VerificationIssue.VerificationEvidenceLoadFailed errors ] ->
                      let hasInvalidExit =
                          errors
                          |> List.exists (function
                              | VerificationEvidenceLoadError.ParseError(VerificationEvidenceParseError.InvalidExitCode _) ->
                                  true
                              | _ -> false)
          ...
          test "one-record consumption loads evidence correctly" {
              ...
              try
                  ...
                  | EpisodeEngineExecution.Completed result ->
                      ...
                      Expect.equal
                          result.Summary.VerificationEvidenceTotal
                          0
                          "verification_evidence_total should be 0 (no evidence in normalized output without matching declarations)"
                      ...
                      Expect.equal result.Summary.InvalidDeclarations 0 "invalid_declarations = 0"
                  | EpisodeEngineExecution.Failed f -> failwithf "Engine should complete with valid evidence, got: %A" f
              finally
                  cleanup dir
          }
          ...
          test "one-record consumption with declaration creates episode" {
              ...
              try
                  ...
                  let manifest1 =
                      """{"schema_version":"capture-manifest-v1","capture_id":"cap-001","capture_kind":"binlog","raw_artifacts":["test.binlog"],"command":"dotnet build","working_directory":"/tmp","dotnet_sdk_version":"9.0.100","msbuild_version":"17.12.0","fsharp_compiler_version":"9.0.0","operating_system":"linux","architecture":"x64","culture":"en-US"}"""

                  let manifest2 =
                      """{"schema_version":"capture-manifest-v1","capture_id":"cap-002","capture_kind":"binlog","raw_artifacts":["test.binlog"],"command":"dotnet build","working_directory":"/tmp","dotnet_sdk_version":"9.0.100","msbuild_version":"17.12.0","fsharp_compiler_version":"9.0.0","operating_system":"linux","architecture":"x64","culture":"en-US"}"""
                  ...
                  let declarationJson =
                      sprintf
                          """{"schema_version":"repair-episode-declaration-v1","episode_key":"key-001","before_capture_id":"cap-001","after_capture_id":"cap-002","before_commit_oid":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","after_commit_oid":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","verification_evidence_ids":["%s"],"declared_relevant_paths":["src/Program.fs"]}"""
                          evidenceId
