...
let geometryValidationTests =
    testList
        ...
        [
          ...
          test "resolveCommitGeometryWithSubjectStrict rejects empty OID" {
              let result =
                  resolveCommitGeometryWithSubjectStrict (Directory.GetCurrentDirectory()) ""
          ...
          test "resolveCommitGeometryWithSubjectStrict rejects HEAD symbolic ref" {
              let result =
                  resolveCommitGeometryWithSubjectStrict (Directory.GetCurrentDirectory()) "HEAD"
          ...
          test "resolveCommitGeometryWithSubjectStrict rejects branch names" {
              let result =
                  resolveCommitGeometryWithSubjectStrict (Directory.GetCurrentDirectory()) "master"
          ...
          test "resolveCommitGeometryWithSubjectStrict rejects abbreviated commit" {
              let result =
                  resolveCommitGeometryWithSubjectStrict (Directory.GetCurrentDirectory()) "abc1234"
          ...
          test "resolveCommitGeometryWithSubjectStrict rejects invalid hex chars" {
              let result =
                  resolveCommitGeometryWithSubjectStrict (Directory.GetCurrentDirectory()) (String.replicate 40 "g")
          ...
          test "resolveCommitGeometryWithSubjectStrict rejects nonexistent commit" {
              ...
              let result =
                  resolveCommitGeometryWithSubjectStrict (Directory.GetCurrentDirectory()) nonexistentOid
          ...
          test "resolveCommitGeometryWithSubjectStrict rejects blob object" {
              ...
              let result =
                  resolveCommitGeometryWithSubjectStrict (Directory.GetCurrentDirectory()) blobOid

              match result with
              | Result.Error(CommitGeometryError.GitFailure _) -> ()
              | Result.Error CommitGeometryError.DirtyWorktree -> printfn "Note: Worktree check failed"
              | Result.Error CommitGeometryError.UnspecifiedHead -> ()
              | Result.Error(CommitGeometryError.RepositoryNotFound _) -> ()
    ...
    testList
        ...
        [
          ...
          test "verificationEvidenceSemanticallyEqual compares all fields" {
              ...
              Expect.isFalse
                  (verificationEvidenceSemanticallyEqual evidence1 evidence2)
                  "different stdout_sha256 should not be equal"
          } ]
        ...
        [
          ...
          test "empty evidence file returns Completed" {
              ...
              try
                  ...
                  | EpisodeEngineExecution.Failed _ -> failwith "Empty evidence should succeed"
              finally
                  cleanup dir
          }
          ...
          test "one valid evidence record returns Completed" {
              ...
              try
                  ...
                  | EpisodeEngineExecution.Failed f -> failwithf "Should succeed with valid evidence, got: %A" f
              finally
                  cleanup dir
          }
              ...
              try
                  ...
                  | EpisodeEngineExecution.Completed result ->
                      ...
                      Expect.equal
                          ...
                          0
                          "verification_evidence_total should be 0 (evidence not associated without verification level)"
