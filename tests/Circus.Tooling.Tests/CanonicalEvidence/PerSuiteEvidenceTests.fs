        ...
        [
          ...
          test "conflicting records produce ConflictingEvidenceRecord" {
              ...
              try
                  ...
                  let rec2 =
                      sprintf
                          """{"schema_version":"verification-evidence-v1","verification_evidence_id":"%s","episode_id":"ep-conflict-2","verification_kind":"build","verification_command":"dotnet build","verification_result":"fail","verification_exit_code":1,"tested_commit_oid":"%s","tested_tree_oid":"%s"}"""
                          validEvidenceId
                          validCommitOid
                          validTreeOid
          ...
          test "empty evidence file returns Completed with verification_evidence_total = 0" {
              ...
              try
                  ...
                  | EpisodeEngineExecution.Failed _ -> failwith "Engine should succeed with empty evidence"
              finally
                  cleanup dir
          }
        ...
        [
          ...
          test "first two identical, third conflicts => ConflictingEvidenceRecord" {
              ...
              try
                  ...
                  let rec3 =
                      sprintf
                          """{"schema_version":"verification-evidence-v1","verification_evidence_id":"%s","episode_id":"ep-conflict","verification_kind":"build","verification_command":"dotnet build","verification_result":"fail","verification_exit_code":1,"tested_commit_oid":"%s","tested_tree_oid":"%s"}"""
                          validEvidenceId
                          validCommitOid
                          validTreeOid
          ...
          test "Engine Completed with one valid evidence record" {
              ...
              try
                  ...
                  | EpisodeEngineExecution.Failed f -> failwithf "Engine failed: %A" f
              finally
                  cleanup dir
          }
          ...
          test "verificationEvidenceSemanticallyEqual compares all fields" {
              ...
              Expect.isFalse
                  (verificationEvidenceSemanticallyEqual record1 { record1 with EpisodeId = "ep-002" })
                  "episode diff"

              Expect.isFalse
                  (verificationEvidenceSemanticallyEqual
                      record1
                      { record1 with
          ...
          test "LocatedVerificationEvidence includes source location" {
              ...
              let located =
                  { Evidence = evidence
                    SourcePath = "/path/to/evidence.jsonl"
                    SourceLine = 5 }
