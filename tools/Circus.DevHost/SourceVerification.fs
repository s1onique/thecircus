...
let verifyRestore (runner: IProcessRunner) (dotnetRoot: string) (repoRoot: string) : Result<unit, DevHostFailure> =
    match
        runDotnetCommand
            runner
            dotnetRoot
...
let verifyBuild (runner: IProcessRunner) (dotnetRoot: string) (repoRoot: string) : Result<unit, DevHostFailure> =
    match
        runDotnetCommand
            runner
            dotnetRoot
...
let verifySource (runner: IProcessRunner) (dotnetRoot: string) (repoRoot: string) : Result<unit, DevHostFailure> =
